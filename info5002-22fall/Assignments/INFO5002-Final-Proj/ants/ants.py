...
class Ant(Insect):
    ...
    def double(self):
        ...
        if self.is_container and self.ant_contained is not None and not self.ant_contained.damage_doubled:
            self.ant_contained.damage *= 2
            self.ant_contained.damage_doubled = True
        # END Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        currLocation = self.place
        attackRange = 0
        while not currLocation.is_hive:
            if currLocation.bees and self.lower_bound <= attackRange <= self.upper_bound:
                return random_bee(currLocation.bees)
            attackRange += 1
            currLocation = currLocation.entrance
        # END Problem 3 and 4
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def action(self, gamestate):
        ...
        # double damage of ants behind the QueenAnt
